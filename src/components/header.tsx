  ...
  return (
    <>
      <header className="bg-[#1E293B] relative z-50">
        <div className="max-h-screen sticky top-0 gap-10 left-0 h-full w-full text-white flex items-start justify-between p-10 flex-col">
          <div>
          ...
          <div className="max-w-3xl">
            ...
            <a href="mailto:hello@pollycon.co.uk" className="border border-[#96BF48] text-[#96BF48] hover:bg-[#96BF48] hover:text-[#1E293B] transition-all duration-150 inline-flex hover:scale-105 hover:shadow-md hover:shadow-neutral-7900 text-base py-2 px-4 font-dm_sans font-semibold rounded-full mt-8">Let&rsquo;s work together</a>
            </div>
          <div className="text-[#C3D4F0] text-xs leading-6">
            Find me on <a target="_blank" rel="noopener" className="underline" href="https://twitter.com/jamiethroup">X</a>, <a target="_blank" rel="noopener" className="underline" href="https://github.com/jamiethroup">Github</a> and <a className="underline" href="https://www.linkedin.com/in/jamiethroup/">Linkedin</a><br></br>
            <a target="_blank" rel="noopener" href="https://drive.google.com/file/d/1916JT7S5UEFp_t-igMjx1GJ-N8WXcvpr/view?usp=sharing" className="underline">Download</a> my Resume (PDF)
          </div>
        </div>
      </header>
    </>
