...
export default function Header() {
  return (
    <header className='absolute z-40 top-0 left-0 w-full px-6'>
      <div className='container max-w-7xl mx-auto grid grid-cols-12 py-6'>
        ...
        <div className="hidden md:col-span-10 md:flex items-center justify-end">
          <nav>
            ...
            {links.map((link, i) => (
              <li key={link.path}>
                <a className='font-outfit text-white block text-sm hover:-translate-y-0.5 duration-150 font-medium' href={link.path}>{link.label}</a>
              </li>
            ))}
            <li>
