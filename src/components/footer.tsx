        ...
        <div className='container mx-auto px-6 max-w-7xl pb-10 md:pb-20 pt-20'>
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            <ul className='mt-8 flex gap-4'>
              ...
              <li>
                <a href="https://www.linkedin.com/in/jamiethroup/" className='footer__social-icon'>
                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 750 750">
